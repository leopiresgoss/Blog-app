...
RSpec.describe 'Posts Page', type: :system do
  before :each do
    ...
    Comment.create(author: @first_user, post: @first_post, text: '1-comment')
    Comment.create(author: @first_user, post: @first_post, text: '2-comment')
    Comment.create(author: @first_user, post: @first_post, text: '3-comment')
