...
RSpec.describe 'User1 Page', type: :system do
  before :each do
    ...
    Post.create(author: @first_user, title: 'title1', text: 'test')
    Post.create(author: @first_user, title: 'title2', text: 'test')
    Post.create(author: @first_user, title: 'title3', text: 'test')
    @last_post = Post.create(author: @first_user, title: 'title4', text: 'test')
  end
  ...
  describe 'Shows User1' do
    ...
    it 'shows See All Posts button' do
      expect(page).to have_link('See all posts', href: "#{@first_user.id}/posts")
    end
